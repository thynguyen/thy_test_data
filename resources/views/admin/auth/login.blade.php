<html lang="en">
    ...
    <!--end::Head--><!--begin::Body-->
    <body class="login-page bg-body-secondary app-loaded" cz-shortcut-listen="true">
        <div class="login-box">
                ...
                <div class="card-body login-card-body">
                    ...
                    <form method="post" action="{{ route('admin.postLogin') }}">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" placeholder="User Name">
